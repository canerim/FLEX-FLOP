...
def content(k):
    ...
    k.fig("window.png",
          ...
          "formality. The main paper states both limits; this is them drawn.")
    ...
    k.rows(_ceiling_rows(k),
           ...
           "training absorbs most of it -- the trained floor at the shipped "
           "split is \\FloorHigh dB at q63 against the untrained number in "
           "this table -- so read the seam columns as a ratio between splits "
           "rather than as decibels a trained model would pay. Halving the "
           "split depth is worth about "
