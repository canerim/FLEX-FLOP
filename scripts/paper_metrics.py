...
def main():
    ...
    CONFIGS = [
        ...
        ("B router", ["router_RECIPE512_b01_e4head.json", "router_RECIPE512_b01_PAPER.json",
                      "router_RECIPE512_b01_fixed.json",
                      "router_RECIPE512_b01.json",
                      "router_RECIPE512_lam1.3e-5.json",
                      "router_BEST_v2.json"], 0.1),
        ("B router", ["router_RECIPE512_b03_e4head.json", "router_RECIPE512_b03_PAPER.json",
                      "router_RECIPE512_b03_fixed.json",
                      "router_RECIPE512_b03.json"], 0.3),
        ("B router", ["router_RECIPE512_b05_e4head.json", "router_RECIPE512_b05_PAPER.json",
