...
def inputs_figure():
    ...
    a.text(floor + 0.008, y[0] + 0.55, "best constant exit", fontsize=5.2,
    ...
    b.legend(ncol=4, fontsize=5.0, loc="lower center",
...
def frontier_figure():
    ...
    axes[1].text(len(qs) - 1.05, ceil + 0.8, "ceiling", fontsize=5.2,
                 color=ns.INK2, ha="right")
    axes[0].legend(ncol=2, fontsize=5.2, loc="lower left", handlelength=1.3,
