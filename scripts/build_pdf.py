...
def content(colw, fullw):
    ...
    par(r"The highest rate is where this used to fail outright, and it is "
        ...
        r"\HeldFloorTestHigh dB on the test frames, a gap of "
        r"\HeldFloorGapMin to \HeldFloorGapMax dB across the ladder. On an "
        ...
        r"now. The gap itself does not close, and it is the reason the "
        r"transfer undershoots -- a budget written as an absolute decibel "
        r"sits a different distance above the floor on 512px photographs than "
        r"on 1080p video.")
