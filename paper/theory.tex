...
classes B, C and D are not measured). Distortion is measured against the
\emph{released} decoder from the identical bitstream, so the encoder, hyperprior and entropy model are
