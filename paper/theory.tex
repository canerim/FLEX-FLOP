...
$\mathrm{dB}(S)$ is convex here --- by Proposition~\ref{prop:logconvex} and
measurement, not by assumption. Fitting a quartic and differentiating it twice
instead reports $69$--$78\%$, but those violations sit entirely at the
...
budget below $\delta$ is then unreachable at every assignment --- not because
routing fails, but because $\mathcal{A}$ does not intersect the constraint.
